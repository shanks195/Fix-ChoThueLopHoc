  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      >
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="120px">
          ...
          <el-form-item label="Description" prop="description">
            ...
            <el-input v-model="form.link" style="width: 640px;" />
          </el-form-item>
        </el-form>
      ...
      >
        ...
        <el-table-column v-permission="['admin','intro:edit','intro:del']" label="Operating" width="150px" align="center">
          <template slot-scope="scope">
...
<script>
import crudIntroduce from '@/api/introduce'
