  ...
  <el-dialog append-to-body :close-on-click-modal="false" :visible.sync="dialog" title="Application deployment" width="400px">
    <el-form ref="form" :model="form" :rules="rules" size="small">
      ...
      >
        ...
        <div slot="tip" class="el-upload__tip">The name of the uploaded file for multiple applications is all.zip, and the extension of the database update script is .sql. After the upload is successful, the system will automatically deploy the system.</div>
      </el-upload>
    </el-form>
