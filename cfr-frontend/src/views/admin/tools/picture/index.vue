  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!--search for-->
        <el-input v-model="query.filename" clearable size="small" placeholder="Input file name" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <el-date-picker
      ...
      <crudOperation :permission="permission">
        ...
        <el-button
          ...
          @click="dialog = true"
        >Upload</el-button>
        <el-tooltip slot="right" class="item" effect="dark" content="To use the synchronization function, you need to register an account in https://sm.ms/login, and modify the Secret Token in the application.yml file" placement="top-start">
          <el-button
            v-permission="['admin','pictures:add']"
            class="filter-item"
            size="mini"
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column width="200" prop="filename" label="File" />
      <el-table-column prop="username" label="User" />
      <el-table-column ref="table" :show-overflow-tooltip="true" prop="url" label="URL">
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'Image', url: 'api/pictures', crudMethod: { ...crudPic }})
  },
