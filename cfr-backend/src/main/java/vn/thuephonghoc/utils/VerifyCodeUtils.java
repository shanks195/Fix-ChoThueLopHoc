...
public class VerifyCodeUtils{
	...
	//Algerian font is used. If there is no font in the system,  need to install the font. The font only displays uppercase, and the 1,0,i,o characters that are easy to be confused are removed
    private static final String VERIFY_CODES = "23456789ABCDEFGHJKLMNPQRSTUVWXYZDINHDUCTHIEN";
