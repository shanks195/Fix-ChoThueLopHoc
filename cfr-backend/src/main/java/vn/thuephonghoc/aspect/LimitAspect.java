...
public class LimitAspect {
    ...
    @Pointcut("@annotation(vn.thuephonghoc.annotation.Limit)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (null != count && count.intValue() <= limit.count()) {
        	logger.info("The {} access key is {}, described as the interface of [{}]", count, keys, limit.name());
            return joinPoint.proceed();
        } else {
            throw new BadRequestException("Access is restricted");
        }
    }
