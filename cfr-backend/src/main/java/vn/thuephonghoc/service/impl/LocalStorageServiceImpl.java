...
import vn.thuephonghoc.mapper.LocalStorageMapper;
import vn.thuephonghoc.query.LocalStorageQueryCriteria;
import vn.thuephonghoc.repository.LocalStorageRepository;
...
//        String type = FileUtil.getFileTypeByMimeType(suffix);
    ...
    public void download(List<LocalStorageDto> queryAll, HttpServletResponse response) throws IOException {
        ...
        for (LocalStorageDto localStorageDTO : queryAll) {
            ...
            map.put("Operator", localStorageDTO.getOperate());
            map.put("Create Date", localStorageDTO.getCreateTime());
            list.add(map);
        }
